            ...
            <>
              ...
              <section className="bg-zinc-800 rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between"><span>總用戶</span><span>{stats?.totalUsers || 0}</span></div>
                  <div className="flex justify-between"><span>→ 看過付費頁</span><span>{stats?.pricingViews || 0}</span></div>
                  <div className="flex justify-between"><span>→ 付費</span><span>{paidUsers}</span></div>
                </div>
              </section>
            </>
          )}
